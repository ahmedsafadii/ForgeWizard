//
//  MainRunesBuildTableViewCell.swift
//  Forge Wizard
//
...
class MainRunesBuildTableViewCell: UITableViewCell {
    ...
    func setupColor(){
        ...
        let color = getBuildRuneColor(runeId: buildData["rune_main"]["rune_id"].stringValue)
    
        main_v_view.backgroundColor = color
        main_title.textColor = color
        main_title.text = buildData["rune_main"]["rune_title"].stringValue
        mainDescription.text = buildData["rune_main"]["rune_description"].stringValue
        print("dasdadas",buildData["rune_main"]["rune_id"].stringValue)
        main_rune.image = UIImage(named: buildData["rune_main"]["rune_id"].stringValue)

        main_border.image = UIImage(named: buildData["rune_main"]["rune_title"].stringValue.lowercased() + "_border")
        ...
        for i in 0...main_titles.count - 1 {
            ...
            main_titles[i].text = buildData["primary_data"][i]["build_keystone"]["stone_title"].stringValue
        }
        
        for i in 0...main_description.count - 1 {
            main_description[i].text = buildData["primary_data"][i]["build_keystone"]["stone_long_description"].stringValue.htmlToString
        }
        
        for i in 0...main_images.count - 1 {
            main_images[i].borderColor = color
            main_images[i].image = UIImage(named:buildData["primary_data"][i]["build_keystone"]["stone_id"].stringValue)
        }
